    ...
    <section id="work">
      <div className="py-20 w-full px-4">
        ...
        <motion.h2
          ...
          transition={{ duration: 0.1, delay: 0.1 }} // Delay animation by 0.2 seconds
        ...
        <motion.h1
          ...
          transition={{ duration: 0.4, delay: 0.2 }} // Delay the title animation further
        ...
        <motion.div
          ...
          transition={{ duration: 0.4, delay: 0.3 }} // Further delay for the timeline to appear
          viewport={{ once: true, amount: 0.2 }} // Trigger animation when 20% of the element is visible
        >
